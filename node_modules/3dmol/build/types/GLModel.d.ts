...
export declare class GLModel {
    ...
    private calculateTwoColorSegments;
    private findSmallestRing;
    private chooseDashedSide;
    private chooseDashedPlusV;
    private drawAromaticRingTorus;
